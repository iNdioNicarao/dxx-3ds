...
#ifdef __3DS__
#define DS_KEY_A        SDLK_a
#define DS_KEY_B        SDLK_b
#define DS_KEY_X        SDLK_x
#define DS_KEY_Y        SDLK_y

#define DS_KEY_L        SDLK_l
#define DS_KEY_R        SDLK_r

#define DS_KEY_LEFT     SDLK_LEFT
#define DS_KEY_UP       SDLK_UP
#define DS_KEY_RIGHT    SDLK_RIGHT
#define DS_KEY_DOWN     SDLK_DOWN

#define DS_KEY_START    SDLK_RETURN
#define DS_KEY_SELECT   SDLK_ESCAPE
#endif
