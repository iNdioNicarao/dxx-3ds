...
kc_item kc_keyboard[NUM_KEY_CONTROLS] = {
	...
	{ 14, 15,109, 71, 26, 12, 16, 31, 15,"Slide up", BT_KEY, KEY_RSHIFT, &Controls.key_slide_up_state, STATE_BIT1, NULL },
	{ 15, 15,109,100, 26, 13, 17, 14, 32,"Slide up", BT_KEY, 255, &Controls.key_slide_up_state, STATE_BIT2, NULL },
	{ 16, 15,117, 71, 26, 14, 18, 33, 17,"Slide down", BT_KEY, KEY_LSHIFT, &Controls.key_slide_down_state, STATE_BIT1, NULL },
	...
	{ 24,158, 49, 83, 26, 49, 26,  1, 25,"Fire primary", BT_KEY, KEY_R, &Controls.fire_primary_state, STATE_BIT1, &Controls.fire_primary_count },
	{ 25,158, 49,112, 26, 42, 27, 24,  2,"Fire primary", BT_KEY, 255, &Controls.fire_primary_state, STATE_BIT2, &Controls.fire_primary_count },
	{ 26,158, 57, 83, 26, 24, 28,  3, 27,"Fire secondary", BT_KEY, KEY_L, &Controls.fire_secondary_state, STATE_BIT1, &Controls.fire_secondary_count },
	...
	{ 28,158, 65, 83, 26, 26, 34,  5, 29,"Fire flare", BT_KEY, KEY_SPACEBAR, NULL, 0, &Controls.fire_flare_count },
	...
	{ 34,158, 73, 83, 26, 28, 36,  7, 35,"Drop bomb", BT_KEY, KEY_ENTER, NULL, 0, &Controls.drop_bomb_count },
	...
	{ 44,158, 93, 83, 26, 36, 30, 11, 45,"Automap", BT_KEY, KEY_BACKSP, &Controls.automap_state, STATE_BIT1, &Controls.automap_count },
	{ 45,158, 93,112, 26, 37, 31, 44, 12,"Automap", BT_KEY, 255, &Controls.automap_state, STATE_BIT2, &Controls.automap_count },
	{ 46, 15,157, 71, 26, 22, 48, 23, 47,"Cycle Primary", BT_KEY, KEY_X, NULL, 0, &Controls.cycle_primary_count },
	{ 47, 15,157,100, 26, 23, 49, 46, 48,"Cycle Primary", BT_KEY, 255, NULL, 0, &Controls.cycle_primary_count },
	{ 48, 15,165, 71, 26, 46,  1, 47, 49,"Cycle Second.", BT_KEY, KEY_Y, NULL, 0, &Controls.cycle_secondary_count },
...
kc_item kc_joystick[NUM_JOYSTICK_CONTROLS] = {
	{  0, 22, 46, 82, 26, 15,  1, 24, 29,"Fire primary", BT_JOY_BUTTON, 5, &Controls.fire_primary_state, STATE_BIT3, &Controls.fire_primary_count },
	{  1, 22, 54, 82, 26,  0,  4, 34, 30,"Fire secondary", BT_JOY_BUTTON, 4, &Controls.fire_secondary_state, STATE_BIT3, &Controls.fire_secondary_count },
	{  2, 22, 78, 82, 26, 26,  3, 37, 31,"Accelerate", BT_JOY_BUTTON, 2, &Controls.accelerate_state, STATE_BIT3, NULL },
	{  3, 22, 86, 82, 26,  2, 25, 38, 32,"Reverse", BT_JOY_BUTTON, 1, &Controls.reverse_state, STATE_BIT3, NULL },
	{  4, 22, 62, 82, 26,  1, 26, 35, 33,"Fire flare", BT_JOY_BUTTON, 7, NULL, 0, &Controls.fire_flare_count },
	{  5,174, 46, 74, 26, 23,  6, 29, 34,"Slide on", BT_JOY_BUTTON, 255, &Controls.slide_on_state, STATE_BIT3, NULL },
	{  6,174, 54, 74, 26,  5,  7, 30, 35,"Slide left", BT_JOY_BUTTON, 3, &Controls.btn_slide_left_state, STATE_BIT3, NULL },
	{  7,174, 62, 74, 26,  6,  8, 33, 36,"Slide right", BT_JOY_BUTTON, 0, &Controls.btn_slide_right_state, STATE_BIT3, NULL },
	{  8,174, 70, 74, 26,  7,  9, 43, 37,"Slide up", BT_JOY_BUTTON, 12, &Controls.btn_slide_up_state, STATE_BIT3, NULL },
	{  9,174, 78, 74, 26,  8, 10, 31, 38,"Slide down", BT_JOY_BUTTON, 13, &Controls.btn_slide_down_state, STATE_BIT3, NULL },
	{ 10,174, 86, 74, 26,  9, 11, 32, 39,"Bank on", BT_JOY_BUTTON, 11, &Controls.bank_on_state, STATE_BIT3, NULL },
	{ 11,174, 94, 74, 26, 10, 12, 42, 40,"Bank left", BT_JOY_BUTTON, 14, &Controls.btn_bank_left_state, STATE_BIT3, NULL },
	{ 12,174,102, 74, 26, 11, 28, 41, 41,"Bank right", BT_JOY_BUTTON, 15, &Controls.btn_bank_right_state, STATE_BIT3, NULL },
	{ 13, 22,154, 51, 26, 47, 15, 47, 14,"Pitch U/D", BT_JOY_AXIS, 1, NULL, 0, NULL },
	{ 14, 22,154, 99,  8, 48, 30, 13, 16,"Pitch U/D", BT_INVERT, 255, NULL, 0, NULL },
	{ 15, 22,162, 51, 26, 13,  0, 18, 16,"Turn L/R", BT_JOY_AXIS, 0, NULL, 0, NULL },
	{ 16, 22,162, 99,  8, 14, 29, 15, 19,"Turn L/R", BT_INVERT, 255, NULL, 0, NULL },
	{ 17,164,154, 58, 26, 28, 19, 14, 18,"Slide L/R", BT_JOY_AXIS, 2, NULL, 0, NULL },
	{ 18,164,154,106,  8, 45, 20, 17, 15,"Slide L/R", BT_INVERT, 255, NULL, 0, NULL },
	{ 19,164,162, 58, 26, 17, 21, 16, 20,"Slide U/D", BT_JOY_AXIS, 3, NULL, 0, NULL },
	...
	{ 25, 22, 94, 82, 26,  3, 27, 39, 42,"Rear view", BT_JOY_BUTTON, 8, &Controls.rear_view_state, STATE_BIT3, &Controls.rear_view_count },
	{ 26, 22, 70, 82, 26,  4,  2, 36, 43,"Drop bomb", BT_JOY_BUTTON, 6, NULL, 0, &Controls.drop_bomb_count },
	{ 27, 22,102, 82, 26, 25, 14, 40, 28,"Automap", BT_JOY_BUTTON, 9, &Controls.automap_state, STATE_BIT3, &Controls.automap_count },
	...
	{ 44,174,110, 74, 26, 12, 45, 41, 46,"Cycle Primary", BT_JOY_BUTTON, 11, NULL, 0, &Controls.cycle_primary_count },
	{ 45,174,118, 74, 26, 44, 18, 46, 47,"Cycle Secondary", BT_JOY_BUTTON, 10, NULL, 0, &Controls.cycle_secondary_count },
...
void kc_set_controls()
{
	...
	// Force our baked-in 3DS control defaults, overriding any saved
	// descent.cfg. This guarantees a consistent scheme on every device
	// without the user ever opening the controls menu.
	for (i=0; i<NUM_KEY_CONTROLS; i++ )
		PlayerCfg.KeySettings[0][i] = kc_keyboard[i].value;
	for (i=0; i<NUM_JOYSTICK_CONTROLS; i++ )
		PlayerCfg.KeySettings[1][i] = kc_joystick[i].value;
